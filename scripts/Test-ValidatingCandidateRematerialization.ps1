...
function New-RematerializationFixture {
    ...
    $state.project_id='test-project';$state.current_unit='unit-remat-001';$state.last_event_id='remat-seed-0001';$state.repository_heads=@([pscustomobject][ordered]@{repo_id=$RepoId;head=$predecessorCommit;branch=$predecessorBranch;dirty_fingerprint=$null})
