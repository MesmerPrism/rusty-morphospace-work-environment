...
"@
    ...
    foreach($checkId in @('proposed-unit-retirement','development-unit-admission','recovered-proposal-continuation','recovered-prepared-admission','work-unit-automation','workflow-contracts','public-boundary')){Assert-True (@($proposedRetirementOwnerPlan.selected_checks.check_id)-ccontains$checkId) "Proposed-retirement owner change omitted actual consumer or prerequisite '$checkId'."}
    ...
    $preparationRepositoryScopeConsumerChecks=@(
        ...
        'recovered-proposal-continuation','recovered-prepared-admission','validating-candidate-rematerialization',
    ...
    $proportionalMappings = @(
        ...
        [pscustomobject]@{ path='scripts/AdmissionCompletionTimestampRecovery.psm1'; checks=@('admission-completion-timestamp-recovery','recovered-proposal-continuation','recovered-prepared-admission','workflow-contracts','work-unit-automation','public-boundary') },
        [pscustomobject]@{ path='schemas/admission-completion-timestamp-recovery-v1.schema.json'; checks=@('admission-completion-timestamp-recovery','recovered-proposal-continuation','recovered-prepared-admission','workflow-contracts','work-unit-automation','public-boundary') },
