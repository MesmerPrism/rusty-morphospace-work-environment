...
"@
    ...
    foreach($checkId in @('proposed-unit-retirement','development-unit-admission','recovered-proposal-continuation','recovered-prepared-admission','recovered-preparation-retirement','work-unit-automation','workflow-contracts','public-boundary')){Assert-True (@($proposedRetirementOwnerPlan.selected_checks.check_id)-ccontains$checkId) "Proposed-retirement owner change omitted actual consumer or prerequisite '$checkId'."}
    ...
    $preparationRepositoryScopeConsumerChecks=@(
        ...
        'recovered-proposal-continuation','recovered-prepared-admission','recovered-preparation-retirement','validating-candidate-rematerialization',
