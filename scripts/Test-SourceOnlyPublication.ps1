...
function New-Source($Root,$Id,[string[]]$Paths){
    ...
    [IO.Directory]::CreateDirectory($repo)|Out-Null;Git $Root @('init','--bare',$remote)|Out-Null;Git $repo @('init')|Out-Null;Git $repo @('config','user.email','fixture@example.invalid')|Out-Null;Git $repo @('config','user.name','Fixture')|Out-Null
