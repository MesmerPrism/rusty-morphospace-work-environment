...
function Convert-ToBlockedMissingRequiredSkillFixture($Root) {
    ...
    Write-Json $validationPath ([pscustomobject][ordered]@{schema='rusty.morphospace.workflow.validation_receipt.v1';receipt_id='unit-example-001-validation-blocked';project_id='example-project';unit_id='unit-example-001';result='blocked'})
