...
$phaseIds = @('graph-import-closure','executor-pass-schema','executor-damage','selection-scenarios','trust-mapping-final')
$checkIds = [ordered]@{
    ...
    'trust-mapping-final'='affected-selector-trust-mapping-final'
}
$dependencyPaths = @(
