...
function Assert-PreparationEnvelope {
    ...
    Assert-MorphospaceDevelopmentEnvelope $Preparation $Project $FeatureLock 'ordinary'
}
function Complete-MorphospaceDevelopmentEnvelopePreparation {
    ...
    Assert-MorphospaceDevelopmentEnvelopeAdditiveProject $intent.pre.project.document $intent.target.project.document ($null-ne$receipt.envelope.psobject.Properties['schema_pin_revision']) @($receipt.envelope.owner_repositories) 'ordinary'
    Assert-MorphospaceDevelopmentEnvelope $resumePreparation $intent.pre.project.document $intent.pre.feature_lock.document 'ordinary'
