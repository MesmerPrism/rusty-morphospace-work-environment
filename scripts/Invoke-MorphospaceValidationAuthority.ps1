...
$observation = Test-MorphospaceUnitOwnership -WorkspaceRoot $workspace -Ownership $ownership -ClaimBaseline $baseline -ClaimBaselineReference $protocol.claim_baseline -Unit $unit -RepositoryMapReference $protocol.repository_map -RepositoryMap $map.map
...
$afterObservation = Test-MorphospaceUnitOwnership -WorkspaceRoot $workspace -Ownership $ownership -ClaimBaseline $baseline -ClaimBaselineReference $protocol.claim_baseline -Unit $unit -RepositoryMapReference $protocol.repository_map -RepositoryMap $map.map
