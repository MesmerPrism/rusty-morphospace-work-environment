...
| `rusty-morphospace-cleanup` | User-requested manual cleanup boundaries, artifact retention, or cleanup safety rules change. | Manual-only cleanup scope, preservation rules, and links to owner guidance. |
